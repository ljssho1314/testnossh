...
function showUser()
{
	...
	xmlhttprequest.send(null);//给服务器发送请求
}
...
<br>
<br>
<input type="button" value="显示列表" onclick="showUser()">
----------------------------------------------------------------------

<table border="1px" id = "t1">
	<tr>
		<td style="width:60px">用户id</td><td style="width:60px">用户名称</td><td  style="width:100px">用户密码</td><td  style="width:60px">年龄</td><td  style="width:60px">电话</td><td  style="width:200px">操作</td>
	</tr>
